...
# Strength .90 (unstable cause) vs. .85 (stable ause)
...
# Open a pdf file
svg("betaplot_high_strength.svg", width = 5, height = 8) 
...
# strength 0.10 (unstable cause) vs. 0.15 (stable cause)
...
# Open a pdf file
svg("betaplot_low_strength.svg", width = 5, height = 8) 
#create plot of Beta distribution with shape parameters 2 and 10
plot(p, dbeta(p, alpha1, beta1, ncp = 0), type='l', col = "red")
lines(p, dbeta(p, alpha2, beta2), type ="l", col= "blue")
dev.off()
